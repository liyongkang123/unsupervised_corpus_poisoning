...
def main():
    ...
    wandb.init(  project="UCP_attack_generate_random_token", )
    ...
    assert attack_args.method == "random_token"
    ...
    for idx, q in enumerate(query_sample):
        ...
        adv_text_list = tokenizer.batch_decode(adv_text_inputs['input_ids'], skip_special_tokens=True)
        ...
        # Determine whether the adv score satisfies ASR
    ...
    attack_results_path = (f"output/attack_results/{attack_args.method}/{attack_args.attack_dataset}/"
                           ...
                           f"random_token-{attack_args.random_token_replacement_rate}.json")
